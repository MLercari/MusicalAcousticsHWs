...
\section{Adjusting the radiation cutoff with the right thickness}
...
where $c$ is the sound velocity in air and $v_p$ is the velocity of the bending waves in the plate.
